...
Every contribution to the Grafana incident.io Plugin is welcome, whether it is
reporting a bug, submitting a fix, proposing new features or becoming a
maintainer. To make contributing to the Grafana incident.io Plugin as easy as
...
- Search through
  [existing open and closed GitHub Issues](https://github.com/ricoberger/grafana-incidentio-plugin/issues)
  for the answer first. If you find a relevant topic, please comment on the
  issue.
- If none of the issues are relevant, please add an
  [issue](https://github.com/ricoberger/grafana-incidentio-plugin/issues).
...
[GitHub](https://github.com/ricoberger/grafana-incidentio-plugin/security/advisories).

## Adding new Features

When contributing a complex change to the Grafana incident.io Plugin, please
